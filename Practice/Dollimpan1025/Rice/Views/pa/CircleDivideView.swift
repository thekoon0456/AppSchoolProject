...
struct CircleDivideView_Previews: PreviewProvider {
    static var previews: some View {
        CircleDivideView().environmentObject(BindingClass())
    }
